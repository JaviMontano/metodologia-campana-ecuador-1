...
function createPitch(lang, outputPath) {
    ...
    pptx.title = lang === 'es' ? 'EstrategIA Personal — Ivan Arrieta, HMV' : 'EstrategIA Personal — Ivan Arrieta, HMV';
    ...
    slide.addText(isEs ? 'Terna: Ivan + Camilo + Johnier — HMV Ingenieros' : 'Trio: Ivan + Camilo + Johnier — HMV Ingenieros', {
    ...
    slide.addText(
        isEs
            ? 'Ivan, le escribimos Javier y Camilo. Queremos que usted, Camilo y Johnier vivan EstrategIA Personal juntos, en terna.\n\nLa idea es crear abundancia para todos.\nComplementario a los talleres de GP en evaluacion en HMV.'
            : 'Ivan, this is Javier and Camilo writing. We want you, Camilo and Johnier to experience EstrategIA Personal together, as a trio.\n\nThe idea is to create abundance for everyone.\nComplementary to the PM workshops under evaluation at HMV.',
    ...
    slide.addText('COP 3.400.000', {
        x: 0.8, y: 2.0, w: 5, h: 1.2, fontSize: 54, fontFace: 'Arial', bold: true, color: BRAND.gold,
    });
    slide.addText(isEs ? 'Terna completa (3 personas)' : 'Complete trio (3 people)', {
        x: 0.8, y: 3.4, w: 5, h: 0.7, fontSize: 20, fontFace: 'Trebuchet MS', color: BRAND.white,
    });
    slide.addText(
        isEs ? 'Precio canonico B2C — Terna de 3 personas\nCatalogo MetodologIA' : 'Canonical B2C price — Trio of 3 people\nMetodologIA Catalog',
    ...
    slide.addText(isEs ? 'Terna: Ivan + Camilo + Johnier' : 'Trio: Ivan + Camilo + Johnier', {
