...
function createPitch(lang, outputPath) {
    ...
    pptx.title = lang === 'es' ? 'Bootcamp Ejecutivo Agentico — CDMX 2026' : 'Executive Agentic Bootcamp — CDMX 2026';
    ...
    slide.addText(isEs ? 'Edicion Creyentes CDMX 2026 — 13 Convocados' : 'Believers Edition CDMX 2026 — 13 Invited', {
    ...
    slide.addText(
        isEs
            ? 'Convocamos a 13 directivos en CDMX que quieran evaluar si la IA agentica tiene sentido para sus organizaciones — y encontrar aliados para dar el paso juntos.\n\nUsted operara con un agente de IA propio desde el dia uno.\nNo es un curso. Es un espacio de evaluacion y co-creacion.'
            : 'We are convening 13 executives in CDMX who want to evaluate whether agentic AI makes sense for their organizations — and find allies to take the step together.\n\nYou will operate with your own AI agent from day one.\nThis is not a course. It is a space for evaluation and co-creation.',
    ...
    slide.addText(
        isEs ? 'Precio especial — Edicion Creyentes CDMX\n(indicative rate, subject to variation)' : 'Special price — Believers Edition CDMX\n(indicative rate, subject to variation)',
