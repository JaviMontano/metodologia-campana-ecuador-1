# Verification Report — Bogota 2026
...
| L7 | Sin referencias a Medellin | PASS | Grep limpio post-adaptacion desde Medellin a Bogota |
...
| W2 | Contacto local ausente | No hay aliado local identificado para Bogota | Identificar aliado o usar convocatoria 100% digital |
...
| Contacto local Bogota | README.md, due-diligence.md | [POR CONFIRMAR] |
...
|---------|--------|-------|
| README.md | OK | Adaptado para Bogota + contexto estrategico Colombia |
| research/kyc-colombia.md | OK | Cubre Medellin + Bogota (compartido) |
| research/due-diligence.md | OK | Especifico Bogota: venues, canales, riesgos |
...
| outputs/dossier-bootcamp-ejecutivo-bogota-2026.html | OK | Todas las refs adaptadas, grep limpio |
