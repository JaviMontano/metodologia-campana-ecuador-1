# Market Research -- MetodologIA Bootcamp Quito 2026
...
## 1. Contexto del mercado global de formacion en IA

El mercado global de formacion corporativa en inteligencia artificial alcanza USD 1.5B en 2024 y se proyecta a USD 10.4B para 2033 [DOC]. America Latina representa el 7.7% de ese mercado, lo que situa la oportunidad regional en aproximadamente USD 800M para 2033 [INFERENCIA].

Los factores de aceleracion incluyen:

- Adopcion de modelos generativos en procesos empresariales [DOC]
- Mandatos regulatorios de competencias digitales en Ecuador (Plan Nacional de Digitalizacion) [DOC]
- Brecha entre demanda de talento IA y oferta local certificada [INFERENCIA]

---

## 2. Macroeconomia Ecuador

| Indicador | Valor | Fuente |
|-----------|-------|--------|
| Empresas activas | 1,073,524 | INEC / SRI [DOC] |
| Personas empleadas | 2,931,588 | INEC [DOC] |
| Ventas totales | USD 202.63B | Superintendencia de Companias [DOC] |
| PIB nominal | ~USD 118B | BCE [DOC] |
| Penetracion internet | 82% | ARCOTEL [DOC] |

Ecuador presenta una economia con base empresarial diversificada, donde el 94% de las empresas son micro o pequenas, pero el 80% del volumen de ventas se concentra en grandes y medianas empresas [INFERENCIA]. Esto define un mercado dual: volumen en B2C individual y ticket alto en B2B corporativo.
...
Segmento alcanzable por MetodologIA considerando:

- Profesionales de nivel ejecutivo y gerencial en Quito y Guayaquil
- Empresas medianas y grandes con presupuesto de capacitacion
- Sector corporativo con iniciativas de (R)Evolucion digital activas

### 3.3 SOM (Serviceable Obtainable Market)

| Periodo | SOM | Observacion |
|---------|-----|-------------|
| Ano 1 | USD 136,049 | 6 ciclos CAO + B2B piloto + 1 Cobrand [DOC] |
| Ano 2 | USD 434,900 | Escala B2B + White Label + Ambassador flywheel [DOC] |
| 24 meses acumulado | USD 570,949 | [DOC] |

El SOM Y1 asume 1 cierre de CAO para break-even en Mes 1 [DOC]. La progresion a Y2 depende del efecto flywheel de Ambassadors y apertura de canales B2B y White Label.

---

## 4. Segmentacion de ingresos

| Segmento | Y1 | Y2 | Descripcion |
|----------|----|----|-------------|
| B2C (CAO + Empowerment + Assistants) | USD 86,849 | USD 150,000 | Individuos, freelancers, ejecutivos [DOC] |
| B2B (Grupos corporativos) | USD 13,200 | USD 98,400 | Empresas que contratan cohorts cerrados [DOC] |
| Cobrand (B2B2B) | USD 36,000 | USD 96,000 | Partners que co-marcan el programa [DOC] |
| White Label | USD 0 | USD 90,500 | Licenciamiento de IP post-Q4 Y1 [DOC] |
| **Total** | **USD 136,049** | **USD 434,900** | |
...
| Producto | Precio | Target | Disponibilidad |
|----------|--------|--------|----------------|
...
|----------|---------------|-------------|
| Burn rate operativo | USD 813 | USD 9,756 [DOC] |
...
## 9. Metricas clave de viabilidad

| Metrica | Valor |
|---------|-------|
| LTV/CAC | 27-40x en Y1 [DOC] |
| Burn mensual | USD 813 [DOC] |
| Break-even | Mes 1 [DOC] |
| Net Y1 | USD 126,293 [DOC] |
| Net Y2 | USD 419,900 [DOC] |
| Equity split | Javier 51% / German 19% / Daniel 13% / Katherin 10% / Cristian 7% [DOC] |
